...
// ---------------------------------------------------------------------------
// Duración de los builds.
//
// El COSTO no se calcula aquí: el endpoint de facturación de Codemagic no
// admite peticiones del navegador (sin CORS), así que lo lee el sync y el
